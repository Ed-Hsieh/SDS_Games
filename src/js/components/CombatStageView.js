        ...
        <div class="vfx-lab adventure-combat-shell" id="adventure-combat-root" data-combat-root data-lab-mode="combat">
            <section class="battle-preview" id="battle-preview" aria-label="戰鬥" tabindex="0">
                ...
                <div class="enemy-intent" id="enemy-intent" hidden>
                    <div class="intent-track"><div class="intent-fill" id="intent-fill"></div><div class="intent-copy"><strong id="intent-name">攻擊</strong><time id="intent-time">0.00s</time></div></div>
                </div>
                ...
                <div class="combat-status-dock" aria-label="玩家戰鬥狀態"><div class="status-lane player-status-strip"><span class="status-label">BUFF</span><div class="buff-list" id="player-buff-list"></div></div><div class="status-lane player-debuff-strip"><span class="status-label">DEBUFF</span><div class="player-debuff-list" id="player-debuff-list"></div></div></div>
                <footer class="player-hud" aria-label="玩家戰鬥狀態">
                    <section class="rhythm-control rhythm-control-main" aria-label="主武器節奏環"><header class="rhythm-control-head"><span>主武器</span><kbd>LMB</kbd></header><div class="combat-rhythm-ring rhythm-ring" id="lab-main-rhythm-ring" data-rhythm-mode="ring"><div class="zone-miss"></div><div class="hit-zone" id="lab-main-hit-zone"></div><div class="crit-zone" id="lab-main-crit-zone"></div><div class="rhythm-needle" id="lab-main-rhythm-needle"><i class="needle-beam"></i><i class="needle-tip"></i></div><div class="rhythm-ring-core"><img id="lab-main-rhythm-icon" alt="" hidden><strong id="lab-main-rhythm-name">徒手</strong><span id="lab-main-rhythm-state">READY</span></div></div><div class="weapon-durability" id="main-weapon-durability" hidden><span>耐久 <strong id="main-weapon-durability-value">--</strong></span><i><b id="main-weapon-durability-fill"></b></i></div></section>
                    ...
                    <section class="rhythm-control rhythm-control-offhand" aria-label="副武器節奏環"><header class="rhythm-control-head"><span>副武器</span><kbd>RMB</kbd></header><div class="combat-rhythm-ring rhythm-ring offhand-rhythm-ring" id="lab-offhand-rhythm-ring" data-rhythm-mode="ring"><div class="zone-miss"></div><div class="hit-zone" id="lab-offhand-hit-zone"></div><div class="crit-zone" id="lab-offhand-crit-zone"></div><div class="rhythm-needle" id="lab-offhand-rhythm-needle"><i class="needle-beam"></i><i class="needle-tip"></i></div><div class="rhythm-ring-core"><img id="lab-offhand-rhythm-icon" alt="" hidden><strong id="lab-offhand-rhythm-name">未裝備</strong><span id="lab-offhand-rhythm-state">WAIT</span></div></div><div class="weapon-durability" id="offhand-weapon-durability" hidden><span>耐久 <strong id="offhand-weapon-durability-value">--</strong></span><i><b id="offhand-weapon-durability-fill"></b></i></div></section>
                </footer>
            </section>
        </div>`;
