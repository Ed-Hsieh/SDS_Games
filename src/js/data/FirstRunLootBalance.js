...
// First-run source ownership is locked here. Combat numbers remain provisional.
export const FirstRunMonsterLootOverrides = Object.freeze({
    ...
    shadow_soldier: { drops: [{ itemId: 'shadow_shard', chance: 0.32, quantity: [1, 1] }, { itemId: 'expedition_steel_fragment', chance: 0.24, quantity: [1, 1] }], equipmentDrops: [{ equipmentId: 'shadow_blade_drop', chance: 0.035 }] },
    shadow_archer: { drops: [{ itemId: 'shadow_arrow', chance: 0.30, quantity: [2, 4] }, { itemId: 'expedition_steel_fragment', chance: 0.20, quantity: [1, 1] }], equipmentDrops: [{ equipmentId: 'shadowneedle_dagger', chance: 0.035 }] },
    shadow_halberdier: { drops: [{ itemId: 'dark_steel', chance: 0.16, quantity: [1, 1] }, { itemId: 'expedition_steel_fragment', chance: 0.26, quantity: [1, 1] }], equipmentDrops: [] },
    shadow_mage: { drops: [{ itemId: 'cursed_shard', chance: 0.12, quantity: [1, 1] }, { itemId: 'magic_crystal', chance: 0.18, quantity: [1, 1] }], equipmentDrops: [{ equipmentId: 'shade_focus', chance: 0.04 }] },
    shadow_commander: { equipmentDrops: [{ equipmentId: 'shadow_commander_blade', chance: 0.25 }] },
    rune_keeper: { drops: [{ itemId: 'ancient_rune', chance: 0.30, quantity: [1, 1] }, { itemId: 'rune_stone', chance: 0.20, quantity: [1, 1] }], equipmentDrops: [] },
    ancient_titan: { drops: [{ itemId: 'titan_heart', chance: 1, quantity: [1, 1] }, { itemId: 'primordial_stone', chance: 0.32, quantity: [1, 1] }, { itemId: 'earth_essence', chance: 0.12, quantity: [1, 1] }, { itemId: 'ember_stone', chance: 1, quantity: [1, 1] }], equipmentDrops: [{ equipmentId: 'titan_hammer', chance: 0.20 }] },
    crystal_golem: { drops: [{ itemId: 'crystal_shard', chance: 0.40, quantity: [1, 2] }, { itemId: 'mithril_ore', chance: 0.10, quantity: [1, 1] }] },
    stone_golem: { equipmentDrops: [] },
    fire_elemental: { equipmentDrops: [] },
    ice_elemental: { equipmentDrops: [] },
    thunder_elemental: { equipmentDrops: [] },
    ember_beast: { drops: [{ itemId: 'ember_stone', chance: 0.22, quantity: [1, 1] }, { itemId: 'lava_scale', chance: 0.08, quantity: [1, 1] }] },
    frost_wolf: { equipmentDrops: [{ equipmentId: 'frostwolf_mantle', chance: 0.045 }] },
    storm_raptor: { equipmentDrops: [{ equipmentId: 'stormfeather_talisman', chance: 0.04 }] },
    poison_frog: { equipmentDrops: [{ equipmentId: 'miasma_needle_focus', chance: 0.04 }] },
    starvein_lurker: { drops: [{ itemId: 'vine_core', chance: 0.36, quantity: [1, 1] }, { itemId: 'primal_essence', chance: 0.14, quantity: [1, 1] }], equipmentDrops: [] },
    elemental_lord: { drops: [{ itemId: 'elemental_core', chance: 1, quantity: [1, 1] }, { itemId: 'primal_essence', chance: 0.45, quantity: [1, 1] }, { itemId: 'fire_essence', chance: 0.18, quantity: [1, 1] }, { itemId: 'molten_core', chance: 0.08, quantity: [1, 1] }], equipmentDrops: [{ equipmentId: 'elemental_orb', chance: 0.18 }] },
    drake: { drops: [{ itemId: 'drake_scale', chance: 0.42, quantity: [1, 2] }, { itemId: 'dragon_tooth', chance: 0.24, quantity: [1, 1] }] },
    sealstone_guardian: { equipmentDrops: [] },
    dragon_seal_sentinel: { equipmentDrops: [{ equipmentId: 'dragonseal_patrol_plate', chance: 0.04 }] },
    dragon_seal_adept: { equipmentDrops: [{ equipmentId: 'dragonseal_forkstaff', chance: 0.06 }] },
    dragon_knight: { equipmentDrops: [] },
    elder_dragon: { drops: [{ itemId: 'dragon_heart', chance: 1, quantity: [1, 1] }, { itemId: 'elder_dragon_scale', chance: 0.55, quantity: [1, 1] }, { itemId: 'dragon_tooth', chance: 0.30, quantity: [1, 1] }], equipmentDrops: [{ equipmentId: 'elder_dragon_fang', chance: 0.15 }] },
    hell_hound: { equipmentDrops: [] },
    lich: { drops: [{ itemId: 'lich_phylactery', chance: 1, quantity: [1, 1] }, { itemId: 'glimmer_shard', chance: 0.25, quantity: [1, 1] }, { itemId: 'frost_crystal', chance: 1, quantity: [1, 1] }], equipmentDrops: [{ equipmentId: 'lich_staff', chance: 0.20 }] },
    drowned_oracle: { drops: [{ itemId: 'ancient_rune', chance: 0.25, quantity: [1, 1] }, { itemId: 'storm_crystal', chance: 1, quantity: [1, 1] }], equipmentDrops: [] },
    demon_lord_asariel: { drops: [{ itemId: 'demon_core', chance: 1, quantity: [1, 1] }, { itemId: 'world_shard', chance: 1, quantity: [1, 1] }], equipmentDrops: [{ equipmentId: 'demon_lord_sword', chance: 0.30 }] }
});

export const FirstRunBlueprintDropOverrides = Object.freeze({
    slime: [],
    wild_wolf: [],
    poison_spider: [{ recipeId: 'poison_dagger', chance: 0.06 }],
    treant: [],
    ambush_mantis: [{ recipeId: 'silver_thread_hook', chance: 0.16 }],
    forest_guardian: [],
    skeleton: [],
    skeleton_warrior: [{ recipeId: 'bone_etched_lance', chance: 0.055 }],
    cave_bat: [],
    ghost: [],
    glimmer_sprite: [],
    rune_wisp: [{ recipeId: 'glimmer_focus', chance: 0.06 }],
    lich: [],
    shadow_soldier: [{ recipeId: 'shadow_armor', chance: 0.035 }],
    shadow_archer: [{ recipeId: 'curse_iron_warhammer', chance: 0.04 }],
    shadow_mage: [], shadow_commander: [], ancient_guardian: [],
    stone_golem: [],
    rune_keeper: [{ recipeId: 'leyline_wedge_lance', chance: 0.065 }],
    ancient_titan: [], ice_elemental: [],
    thunder_elemental: [{ recipeId: 'stormguide_focus', chance: 0.05 }],
    storm_raptor: [],
    fire_elemental: [{ recipeId: 'embercore_focus', chance: 0.05 }],
    poison_frog: [],
    vine_beast: [],
    starvein_lurker: [], elemental_lord: [],
    cliffscale_hatchling: [{ recipeId: 'cliffscale_skinner', chance: 0.045 }],
    crystal_golem: [],
    earth_elemental: [{ recipeId: 'earthwarden_aegis', chance: 0.05 }],
    thorn_witch: [],
    sealstone_guardian: [{ recipeId: 'sealstone_ram', chance: 0.04 }],
    dragon_seal_sentinel: [],
    wyvern: [],
    drake: [],
    dragon_knight: [], elder_dragon: [],
    lava_golem: [{ recipeId: 'molten_core_maul', chance: 0.05 }],
    hell_hound: [],
    tormented_soul: [{ recipeId: 'soul_lantern_focus', chance: 0.05 }],
    shadow_assassin: [],
    shadow_general: [],
