export const TownPlaceDatabase = [
    {
        ...
        cardImage: 'src/assets/images/art/scenes/town/places/crossroads.webp',
        sceneImage: 'src/assets/images/art/scenes/town/places-full/crossroads.webp',
        description: '你走進廣場中央，石板路被來往腳步磨得發亮。村長站在旗繩旁，公告欄上的新紙還帶著墨味，城門外的風聲最早吹到這裡。',
        residents: [
            { npcId: 'village_elder', label: '村長', role: '城鎮管理者', icon: '🏘️', portrait: 'src/assets/images/art/characters/portraits/village_elder.webp', position: { x: 30, y: 58 } }
        ],
        actions: [
    ...
    },
    {
        ...
        cardImage: 'src/assets/images/art/scenes/town/places/market.webp',
        sceneImage: 'src/assets/images/art/scenes/town/places-full/market.webp',
        description: '你掀開帆布棚的陰影，乾燥藥草、空瓶和湯鍋的氣味混在一起。這裡很窄，卻決定了城鎮明天還能不能有人排隊。',
        residents: [
            { npcId: 'herbalist', label: '藥師蓮娜', role: '補給與藥水', icon: '🌿', portrait: 'src/assets/images/art/characters/portraits/herbalist.webp', position: { x: 31, y: 58 } }
        ],
        actions: [
    ...
    },
    {
        ...
        cardImage: 'src/assets/images/art/scenes/town/places/forge.webp',
        sceneImage: 'src/assets/images/art/scenes/town/places-full/forge.webp',
        description: '你推開鍛造鋪的木門，熱浪先一步迎面撞來。爐火、白煙和敲擊聲把外面的怪物都敲進鐵裡，讓抵抗有了可以握住的重量。',
        residents: [
            { npcId: 'blacksmith', label: '鍛造師', role: '鍛造與圖紙', icon: '⚒️', portrait: 'src/assets/images/art/characters/portraits/blacksmith.webp', position: { x: 32, y: 60 } }
        ],
        actions: [
    ...
    },
    {
        ...
        cardImage: 'src/assets/images/art/scenes/town/places/handbook.webp',
        sceneImage: 'src/assets/images/art/scenes/town/places-full/handbook.webp',
        description: '你走進小屋，紙張與乾墨的味道壓過木屑。怪物紀錄、地圖拓片與尚未歸檔的名字堆滿書桌，像有人用筆尖替世界留住呼吸。',
        residents: [
            { npcId: 'town_scholar', label: '書記', role: '旅人手札與百科', icon: '📚', portrait: 'src/assets/images/art/characters/portraits/town_scholar.webp', position: { x: 33, y: 58 } }
        ],
        actions: [
    ...
    },
    {
        ...
        cardImage: 'src/assets/images/art/scenes/town/places/alley.webp',
        sceneImage: 'src/assets/images/art/scenes/town/places-full/alley.webp',
        description: '你拐進狹窄暗巷，屋簷把日光切成很薄的線。流浪者靠在牆邊，黑市標籤與賭場帳冊的耳語都會在這裡沉下來。',
        residents: [
            { npcId: 'street_beggar', label: '巷口流浪者', role: '黑市與城中暗流', icon: '🧥', portrait: 'src/assets/images/art/characters/portraits/street_beggar.webp', position: { x: 32, y: 63 } }
        ],
        actions: [
    ...
    },
    {
        ...
        cardImage: 'src/assets/images/art/scenes/town/places/casino.webp',
        sceneImage: 'src/assets/images/art/scenes/town/places-full/casino.webp',
    ...
    },
    {
        ...
        cardImage: 'src/assets/images/art/scenes/town/places/tower.webp',
        sceneImage: 'src/assets/images/art/scenes/town/places-full/tower.webp',
    ...
    },
    {
        ...
        cardImage: 'src/assets/images/art/scenes/town/places/gate.webp',
        sceneImage: 'src/assets/images/art/scenes/town/places-full/gate.webp',
