...
export const MonsterDatabase = {
    ...
    ancient_titan: {
        ...
        equipmentDrops: [
            { equipmentId: 'titan_hammer', chance: 0.2 }
        ],
    ...
    shadow_halberdier: {
        ...
        hp: 150, maxHp: 150, attack: 35, attackSpeed: 0.9, defense: 13,
        exp: 405, gold: 36,
        drops: [
    ...
    ember_beast: {
        ...
        hp: 293, maxHp: 293, attack: 58, attackSpeed: 0.98, defense: 19,
        exp: 1075, gold: 61,
        drops: [
    ...
    frost_wolf: {
        ...
        hp: 255, maxHp: 255, attack: 62, attackSpeed: 1.25, defense: 15,
        exp: 1170, gold: 63,
        drops: [
    ...
    poison_frog: {
        ...
        hp: 304, maxHp: 304, attack: 58, attackSpeed: 1.05, defense: 18,
        exp: 1320, gold: 67,
        drops: [
    ...
    storm_raptor: {
        ...
        hp: 248, maxHp: 248, attack: 67, attackSpeed: 1.35, defense: 15,
        exp: 1265, gold: 66,
        drops: [
    ...
    vine_beast: {
        ...
        hp: 375, maxHp: 375, attack: 59, attackSpeed: 0.9, defense: 26,
        exp: 1370, gold: 69,
        drops: [
    ...
    cliffscale_hatchling: {
        ...
        hp: 323, maxHp: 323, attack: 68, attackSpeed: 1.15, defense: 20,
        exp: 1530, gold: 73,
        drops: [
    ...
    sealstone_guardian: {
        ...
        hp: 446, maxHp: 446, attack: 63, attackSpeed: 0.85, defense: 34,
        exp: 1645, gold: 76,
        drops: [
    ...
    dragon_seal_sentinel: {
        ...
        hp: 458, maxHp: 458, attack: 72, attackSpeed: 0.95, defense: 31,
        exp: 1820, gold: 80,
        drops: [
    ...
    dragon_seal_adept: {
        ...
        hp: 675, maxHp: 675, attack: 93, attackSpeed: 1.18, defense: 28,
        exp: 3950, gold: 162,
        drops: [
    ...
    hell_hound: {
        ...
        hp: 428, maxHp: 428, attack: 88, attackSpeed: 1.28, defense: 22,
        exp: 2200, gold: 88,
        drops: [
    ...
    tormented_soul: {
        ...
        hp: 398, maxHp: 398, attack: 91, attackSpeed: 1.2, defense: 20,
        exp: 2265, gold: 89,
        drops: [
    ...
    lava_golem: {
        ...
        hp: 623, maxHp: 623, attack: 76, attackSpeed: 0.82, defense: 43,
        exp: 2335, gold: 90,
        drops: [
